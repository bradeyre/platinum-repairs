-- Ticket Lifecycle Analytics Schema - WORKING VERSION
-- This schema stores comprehensive ticket data from RepairShopr for deep analysis
-- FIXED: All SQL syntax errors resolved with proper parameter naming
...
-- WORKING: Function to calculate business hours between two timestamps
-- FIXED: Used different parameter names to avoid conflicts
