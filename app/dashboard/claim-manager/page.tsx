...
export default function ClaimManagerPage() {
  ...
  const completed = damageReports.filter(report => report.status === 'completed' || report.status === 'in_repair')
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        onClick={() => handleManagerDecision(selectedReport.id, 'approve')}
                        className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors text-sm"
                      >
                        Approve Repair
                      </button>
                      <button
                        onClick={() => handleManagerDecision(selectedReport.id, 'ber')}
